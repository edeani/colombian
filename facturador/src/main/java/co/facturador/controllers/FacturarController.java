...
public class FacturarController implements Initializable{
    ...
    public void crearFactura(Pane paneFactura){
        SelectItemDto p1 = new SelectItemDto(1L,"Producto 1");
        SelectItemDto p2 = new SelectItemDto(2L,"Producto 2");
        final ObservableList<SelectItemDto> products  = FXCollections.observableArrayList(p1, p2);
        ObservableList<FacturaTableViewDto> commands  = FXCollections.observableArrayList(new FacturaTableViewDto("1",p1,"fsdf","2","4","")); 
