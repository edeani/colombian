...
import co.facturador.entity.Inventario;
...
public class InventarioJpaController implements Serializable {
    ...
    public void create(Inventario inventario) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findInventario(inventario.getCodigoProductoInventario()) != null) {
    ...
    public void edit(Inventario inventario) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Double id = inventario.getCodigoProductoInventario();
    ...
    public void destroy(Double id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                inventario.getCodigoProductoInventario();
    ...
    public Inventario findInventario(Double id) {
        EntityManager em = getEntityManager();
        try {
