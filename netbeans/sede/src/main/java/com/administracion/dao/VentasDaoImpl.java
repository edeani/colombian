...
public class VentasDaoImpl implements VentasDao{
    ...
    public List<VentasMapper> getVentasMesa(DataSource dataSource, Date fi, Date ff) {
        ...
        String query = "SELECT  'MESAS', productos.codigo_producto,   productos.descripcion_producto,   detalle_mesa.valor_producto, SUM(detalle_mesa.numero_unidades) "
    ...
    public List<VentasMapper> getVentasMostrador(DataSource dataSource, Date fi, Date ff) {
        ...
        DateFormat dfDefault = DateFormat.getDateInstance(DateFormat.SHORT, Locale.UK);
        String query = " SELECT  'MOSTRADOR',productos.codigo_producto,   productos.descripcion_producto,   detalle_llevar.valor_producto, SUM(detalle_llevar.numero_unidades) " +
