 ...
 */
@Repository
public class FacturasComprasDaoImpl extends GenericDaoImpl<FacturasCompras> implements FacturasComprasDao {
    ...
    public void guardarFacturaComprasDao(DataSource nameDataSource, FacturasCompras facturasCompras) {
        ...
        try {
            this.jdbctemplate.execute(insertJdbTemplate("referencia,fecha,idsede,total,idcuenta", "facturas_compras",
    ...
    public void actualizarFacturaComprasDao(DataSource nameDataSource, FacturasCompras facturasCompras) {
        this.jdbctemplate = new JdbcTemplate(nameDataSource);
        try {
            this.jdbctemplate.execute(updateJdbTemplate("fecha='" + Formatos.dateTostring(facturasCompras.getFecha())
