...
<form:form target="_blank" commandName="${commandName}" path="DetalleFacturaTrasladoDTO" action="${pageContext.servletContext.contextPath}/${sessionScope.path}/${sessionScope.path}/traslados/ajax/guardarTraslado.htm" >
