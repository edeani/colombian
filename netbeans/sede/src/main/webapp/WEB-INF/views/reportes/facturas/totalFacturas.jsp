...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/${sessionScope.path}/${sessionScope.path}/factura/reportes/totalFacturasPDF.htm">
        <form target="_blank" method ="POST" action="<%=request.getContextPath()%>/${sessionScope.path}/factura/reportes/totalFacturasPDF.htm">
            <label>Fecha Inicial
            ...
            <label>
                <input id="reporteTotalFacturas"  type="submit" value="Aceptar"/>
            </label>
        </form>
    </div>
</div>
