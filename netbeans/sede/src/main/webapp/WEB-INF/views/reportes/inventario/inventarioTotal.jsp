...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/${sessionScope.path}/${sessionScope.path}/inventario/reportes/inventarioTotalPDF.htm">
        <form target="_blank" action="<%=request.getContextPath()%>/${sessionScope.path}/inventario/reportes/inventarioTotalPDF.htm">
            <label>Fecha Inicial
            ...
            <label>
                <input id="reporteInventarioTotal" type="submit" value="Aceptar"/>
            </label>
        </form>
    </div>
</div>
