...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/${sessionScope.path}/${sessionScope.path}/cajamenor/reporte/pdf.htm">
        <form target="_blank" action="<%=request.getContextPath()%>/${sessionScope.path}/cajamenor/reporte/pdf.htm">
            <label>Fecha Inicial
