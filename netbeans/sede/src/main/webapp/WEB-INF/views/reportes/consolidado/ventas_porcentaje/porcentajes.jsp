...
<script src="<%=request.getContextPath()%>/js/ventas/ventas-porcentajes.js" type="text/javascript"> </script>
...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/${sessionScope.path}/${sessionScope.path}/consolidado/ventasProcentajePDF.htm">
        <form id="formPorcVentas" action="<%=request.getContextPath()%>/${sessionScope.path}/consolidado/ajax/ventasProcentajePDF.htm">
            <label>Fecha Inicial
            ...
            <label>
                <button id="reporteVentasPorcentajes" type="submit" >
                    Aceptar
                </button>
            </label>
            <label>
                <button  id="reporteVentasPorcentajesXls" type="submit" 
