...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/${sessionScope.path}/${sessionScope.path}/consolidado/ventasProcentajePDF.htm">
        <form target="_blank" method ="POST" action="<%=request.getContextPath()%>/${sessionScope.path}/consolidado/ventasProcentajePDF.htm">
            <label>Fecha Inicial
            ...
            <label>
                <input id="reporteVentasPorcentajes"  type="submit" value="Aceptar"/>
            </label>
        </form>
    </div>
</div>
