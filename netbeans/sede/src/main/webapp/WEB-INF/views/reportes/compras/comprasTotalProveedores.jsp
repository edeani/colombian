...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/${sessionScope.path}/${sessionScope.path}/compras/reportes/comprasTotalXProveedorPDF.htm">
        <form   target="_blank" action="<%=request.getContextPath()%>/${sessionScope.path}/compras/reportes/comprasTotalXProveedorPDF.htm">
            <label>Fecha Inicial
