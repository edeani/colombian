...
<head>
    <link href="<%=request.getContextPath()%>/css/bootstrap.min.css" media="all" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <form id="formpho" method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/${sessionScope.path}/logo/guardar.htm">
        <div id="content-img" style="width: 100%; height: 100%;" >
            ...
            <p>Selecione la im&aacute;gen del Producto(Tama&ntilde;o m&aacute;ximo permitido 5M)</p>
        </div>    
    </form>
