...
<div id="formFactura" data-url="${pageContext.servletContext.contextPath}/${sessionScope.path}/factura/ajax/formFactura.htm">                                 
    <form:form target="_blank" commandName="${commandName}" path="ComprobanteCierreSedesDto" data-urlcomprobantepdf="${pageContext.servletContext.contextPath}/consolidado/comprobante/sede/pdf.htm" data-urlcomprobante="${pageContext.servletContext.contextPath}/${sessionScope.path}/consolidado/ajax/comprobante/sede/generar.htm" action="${pageContext.servletContext.contextPath}/${sessionScope.path}/consolidado/ajax/comprobante/sede/guardar.htm" >
