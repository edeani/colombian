...
<div id="formPago" data-url="${pageContext.servletContext.contextPath}/${sessionScope.path}/cajamenor/ajax/secuencia.htm">                                 
    <form:form target="_blank" commandName="${commandName}" path="PagosTercerosDto" data-urlcomprobante="${pageContext.servletContext.contextPath}/cajamenor/terceros/pdf/comprobante.htm" action="${pageContext.servletContext.contextPath}/${sessionScope.path}/cajamenor/ajax/terceros/guardar.htm" >
