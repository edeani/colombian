 ...
 */
@Repository
public class CierreSedesDaoImpl extends DataGenericDao implements CierreSedesDao {
    ...
    public void guardarDetalleComprobanteCierre(String nameDataSource, ComprobanteConsolidadoSedeDto comprobanteConsolidadoSedeDto) {
        ...
        try {
            this.jdbcTemplate.execute(caliycaliDao.insertJdbTemplate("idsede,idcuenta,total,concepto,fecha,fecha_comprobante,idComprobanteCierre", "detalle_cierre_sedes", comprobanteConsolidadoSedeDto.getIdSede() + ",'" + comprobanteConsolidadoSedeDto.getIdCuenta() + "',"
    ...
    public void guardarComprobanteCierre(String nameDataSource, CierreSedes cierreSedes) {
        ...
        try {
            if (cierreSedes.getConsecutivo() == null) {
                this.jdbcTemplate.execute(caliycaliDao.insertJdbTemplate("idsede,totalhaber,totaldeber,fecha,fecha_comprobante", "cierre_sedes", cierreSedes.getIdsede() + "," + cierreSedes.getTotalhaber() + ","
                ...
                this.jdbcTemplate.execute(caliycaliDao.insertJdbTemplate("consecutivo,idsede,totalhaber,totaldeber,fecha,fecha_comprobante", "cierre_sedes",cierreSedes.getConsecutivo()+","+cierreSedes.getIdsede() + "," + cierreSedes.getTotalhaber() + ","
                        + cierreSedes.getTotaldeber() + ",'" + Formatos.dateTostring(cierreSedes.getFecha()) + "','"
                        + Formatos.dateTostring(cierreSedes.getFechaComprobante()) + "'"));
            }
        } catch (DataAccessException e) {
    ...
    public List<ReporteComprobanteCierreDto> buscarDetalleComprobanteCierreSedesView(String nameDataSource, Long idComprobanteCierre) {
        ...
        try {
            ...
            reporte = this.jdbcTemplate.query(sql, new BeanPropertyRowMapper<ReporteComprobanteCierreDto>(ReporteComprobanteCierreDto.class));
        } catch (DataAccessException e) {
    ...
    public CierreSedesDto buscarComprobanteCierreDto(String nameDataSource, Long idComprobanteCierre) {
        ...
        try {
            ...
            cierreSedesDto = this.jdbcTemplate.queryForObject(query, new BeanPropertyRowMapper<CierreSedesDto>(CierreSedesDto.class));
        } catch (DataAccessException e) {
    ...
    public List<CierreSedesDto> buscarComprobanteCierreDtoXFecha(String nameDataSource, String fechaInicial, String fechaFinal) {
        ...
        try {
            ...
            cierreSedesDto = this.jdbcTemplate.query(query, new BeanPropertyRowMapper<CierreSedesDto>(CierreSedesDto.class));
        } catch (DataAccessException e) {
            System.out.println("Error buscarComprobanteCierreDto::" + e.getMessage());
        }
        return cierreSedesDto;
    ...
    public List<ComprobanteConsolidadoSedeDto> buscarConsignacionesXFecha(String nameDataSource, String fechaInicial, String fechaFinal) {
        ...
        try {
            consignaciones = this.jdbcTemplate.query(caliycaliDao.selectJdbTemplate("*",
                    "detalle_cierre_sedes", "fecha_comprobante between '" + fechaInicial + "' and '" + fechaFinal + "' and idcuenta='11050501'"), new BeanPropertyRowMapper<ComprobanteConsolidadoSedeDto>(ComprobanteConsolidadoSedeDto.class));
        } catch (DataAccessException e) {
    ...
    public void borrarComprobanteCierre(String nameDataSource, Long idComprobanteCierre) {
        try {
            this.jdbcTemplate = new JdbcTemplate(projectsDao.getDatasource(nameDataSource));
            this.jdbcTemplate.execute(caliycaliDao.deleteJdbTemplate("cierre_sedes", "consecutivo=" + idComprobanteCierre));
        } catch (DataAccessException e) {
    ...
    public void borrarDetalleComprobanteCierre(String nameDataSource, Long idComprobanteCierre) {
        try {
            this.jdbcTemplate = new JdbcTemplate(projectsDao.getDatasource(nameDataSource));
            this.jdbcTemplate.execute(caliycaliDao.deleteJdbTemplate("detalle_cierre_sedes", "idcomprobantecierre=" + idComprobanteCierre));
        } catch (DataAccessException e) {
    ...
    public CierreSedes buscarCabeceraComprobanteCierreXFechaXSede(String nameDataSource, String fechaInicial, String fechaFinal, Long idSede) {
        ...
        try {
            this.jdbcTemplate = new JdbcTemplate(projectsDao.getDatasource(nameDataSource));
            cierreSedes = this.jdbcTemplate.queryForObject(caliycaliDao.selectJdbTemplate("*", "cierre_sedes", "idsede=" + idSede + " and fecha between '" + fechaInicial + "' and '" + fechaFinal + "'"), new BeanPropertyRowMapper<CierreSedes>(CierreSedes.class));
        } catch (DataAccessException e) {
    ...
    public List<CierreSedesDto> reporteComprobanteCierreSedesView(String nameDataSource, String fechaInicial, String fechaFinal, Long idsede) {
       this.jdbcTemplate = new JdbcTemplate(projectsDao.getDatasource(nameDataSource));
        ...
        try {
            ...
            reporte = this.jdbcTemplate.query(sql, new BeanPropertyRowMapper<CierreSedesDto>(CierreSedesDto.class));
        } catch (DataAccessException e) {
            System.out.println("Error buscarDetalleComprobanteView::" + e.getMessage());
        }
