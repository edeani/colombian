$(document).ready(function() {
    ...
    $(document).on("keyup", ".claseCompra", function(event) {
        if (event.keyCode === $.ui.keyCode.TAB && $(this).autocomplete("instance").menu.active) {
            ...
            $(this).autocomplete({
                source: "/chia/factura/ajax/proveedor/autocompletar.htm?idproveedor=" + $("#idProveedor").val(),
                select: function(event, ui) {
    ...
    $(document).on("change", "#nombreBeneficiario", function() {
        ...
        $("#cmpSecuencia").show();
        //coloco la fecha
        var urlFecha = "/chia/pagos/ajax/fecha.htm";
    ...
    $(document).on("change", "#nombreProveedor", function() {
        ...
        var urlPendientes = "/chia/compras/ajax/avencer.htm";
