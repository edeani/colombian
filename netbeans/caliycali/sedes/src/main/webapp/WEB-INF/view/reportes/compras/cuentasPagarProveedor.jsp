...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/compras/reportes/cuentasPagarProveedorPDF.htm">
        <form   target="_blank" action="<%=request.getContextPath()%>/compras/reportes/cuentasPagarProveedorPDF.htm">
            <label>Fecha Inicial
