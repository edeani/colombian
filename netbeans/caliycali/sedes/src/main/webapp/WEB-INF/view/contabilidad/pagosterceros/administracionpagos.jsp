...
<div id="formPago" data-url="${pageContext.servletContext.contextPath}/pagos/ajax/secuencia.htm">                                 
    <form:form target="_blank" commandName="${commandName}" path="PagosTercerosDto" data-urlcomprobante="${pageContext.servletContext.contextPath}/pagos/terceros/pdf/comprobante.htm" action="${pageContext.servletContext.contextPath}/pagos/ajax/terceros/guardar.htm" >
