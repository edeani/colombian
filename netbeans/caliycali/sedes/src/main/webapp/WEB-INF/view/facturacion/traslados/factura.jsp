...
<div id="formFactura" data-url="${pageContext.servletContext.contextPath}/traslados/ajax/formFactura.htm">
    <form:form target="_blank" commandName="${commandName}" path="DetalleFacturaTrasladoDTO" action="${pageContext.servletContext.contextPath}/traslados/ajax/guardarTraslado.htm" >
