...
public class ComprasMapper {
    ...
    private static final Long sede_default_compra = 1L;
    ...
    public FacturasCompras detalleCompraDTOToFacturasComprasDto(DetalleCompraDTO detalleCompraDTO) {
        ...
        if(detalleCompraDTO.getIdsede()==null){
            facturasCompras.setIdsede(sede_default_compra);
        }else{
            facturasCompras.setIdsede(detalleCompraDTO.getIdsede().longValue());
        }
