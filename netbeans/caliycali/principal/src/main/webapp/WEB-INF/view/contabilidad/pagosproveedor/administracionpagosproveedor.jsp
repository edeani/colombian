...
<div id="formProveedor" data-url="${pageContext.servletContext.contextPath}/pagos/ajax/secuencia.htm">                              
    <input id="cuentaProveedores" value="${cuentaProveedores}" type="hidden">
    <form:form target="_blank" commandName="${commandName}" path="PagosProveedorDto" data-urlcomprobante="${pageContext.servletContext.contextPath}/pagos/proveedores/pdf/comprobante.htm" action="${pageContext.servletContext.contextPath}/pagos/ajax/proveedor/guardar.htm" >
