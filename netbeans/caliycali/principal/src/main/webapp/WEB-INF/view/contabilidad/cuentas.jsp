...
<head>
    ...
    <link href="/colombianCaliyCali/css/jquery-ui.css" rel="stylesheet" type="text/css">
...
<div id="contenidoHome"> 
    ...
    <form:form commandName="${commandName}" path="cuentasPuc" action="${pageContext.servletContext.contextPath}/cuentas/ajax/buscar.htm" >
        <label>
            Cuenta
