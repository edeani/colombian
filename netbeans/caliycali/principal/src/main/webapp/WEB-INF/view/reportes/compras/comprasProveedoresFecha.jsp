...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/compras/reportes/comprasProveedorFechaPDF.htm">
        <form   target="_blank" action="<%=request.getContextPath()%>/compras/reportes/comprasProveedorFechaPDF.htm">
            <label>Fecha Inicial
