                        ...
                        <div id="categoriasDiv" class="col-sm-4">
                            ...
                            <ul class="list-category">
                                <c:forEach items="${categorias}" var="c" varStatus="indice">
                                    <li data-href="${c.nombre}"  style="cursor: pointer;">
                                        <a href="javascript:void(0);" class="categoria" data-id="${c.cons}">
                            ...
                            <div id="content-products" class="col-sm-8">
                                <div class="row">
                                    <div class="col-sm-9">
