...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCuORR5DPzE4CG5YdiEJsV8wn4TrKSbtWw"  async defer></script>
</head>
<body>
    <!-- Inicio contenido del home -->
    <!-- Hero Sliders -->
    <div id="main-slider">
        <div class="owl-carousel owl-theme owl-animated-in">
            <div class="item"><!-- Item Slider #2 -->
                            ...
                            <div class="col-sm-10 col-sm-offset-1">
                                <div class="rst-table">
                                    <div class="rst-table-row">
                                        <div class="rst-table-cell t-slider" style="width: 50%;vertical-align: bottom;"> <img style="opacity:0;" src="/img/post/people.png" alt="" /> </div>
                                        <div class="rst-table-cell" style="width: 50%">
                                            <div class="text-right">
                                                <h2><span>EL MEJOR POLLO</span><br />
                                                    <span>AL ESTILO AMERICANO</span></h2>
                ...
                <img class="owl-main" src="/img/post/slides03.jpg" alt="" /> </div>
            <div class="item active"><!-- Item Slider #1 -->
                ...
                <img class="owl-main" src="/img/post/slides02.jpg" alt="" /> </div>
            <div class="item"><!-- Item Slider #5 -->
                                ...
                                <div class="rst-table">
                                    <div class="rst-table-row">
                                        <div class="rst-table-cell t-slider" style="width: 50%">
                                            ...
                                            <a class="btn btn-lg btn-danger btnslider" href="/contenido/productos.htm">Ver men&uacute;</a> </div>
                                        <!--div class="rst-table-cell" style="width: 50%">
                                          <div class="rst-slider-menu"> <img src="/img/post/bg_slider.jpg" alt="" />
                                            <h3>MEN&Uacute;</h3>
                ...
                <img class="owl-main" src="/img/post/slides04.jpg" alt="" /> </div>
        </div>
    </div>
    <!-- end Hero Sliders -->
    ...
    <div id="content" class="rst-main-content rst-content-full">
            ...
            <div class="row" style="display: none;">
                <div class="col-sm-4">
                    <div class="rst-dishes-item">
                        <div class="rst-thumbnail"> <a href="#"> <img class="img-responsive" src="/img/post/dishes01.jpg" alt="" /> <span class="rst-price">$25.000.95</span> </a> </div>
                        ...
                        <a href="#" class="btn btn-danger btn-lg">PEDIR AHORA</a> </div>
                </div>
                <div class="col-sm-4">
                    <div class="rst-dishes-item">
                        <div class="rst-thumbnail"> <a href="#"> <img class="img-responsive" src="/img/post/dishes02.jpg" alt="" /> <span class="rst-price">$25.000.95</span> </a> </div>
                ...
                <div class="col-sm-4">
                    <div class="rst-dishes-item">
                        <div class="rst-thumbnail"> <a href="#"> <img class="img-responsive" src="/img/post/dishes03.jpg" alt="" /> <span class="rst-price">$25.000.95</span> </a> </div>
        ...
        <div class="rst-dishes" data-background="/img/post/bg_dishes.jpg" style="display: none;">
            <div class="rst-dishes-form clearfix">
                <div class="rst-table">
                    <div class="rst-table-row">
                        <div class="rst-img-dishes rst-table-cell"> <img src="/img/post/img-dishes.png" alt="" /> </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="rst-dishes-action">
                                        ...
                                        <div class="rst-img-product">
                                            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="48.79" height="51" viewBox="0 0 48.79 51">
                                            <defs>
                                            <style>
                                                .cls-1{fill:none;stroke:#5ccd69;stroke-miterlimit:10;}.cls-2{fill:#5ccd69;}
                                            </style>
                                            </defs>
                                            <title>hambu</title>
                                            <path class="cls-1 svghv" d="M44.31,39.75H4.59c-2.14,0-1.31-4.31-1.31-4.31H45.62S46.06,39.75,44.31,39.75Z"/>
                                            <rect class="cls-2 svgh" x="2.62" y="26.59" width="43.55" height="3.21"/>
                                            <path class="cls-2 svgh" d="M23.67,31.76a.86.86,0,0,1,.69.27c.25,0,.64-.12,1.25-.26a7.54,7.54,0,0,0,2.49-1h-5c.15.23.28.44.37.61A1.93,1.93,0,0,0,23.67,31.76Z"/>
                                            <path class="cls-2 svgh" d="M20.18,30.8h-2a1.08,1.08,0,0,0,.93.38A1.71,1.71,0,0,0,20.18,30.8Z"/>
                                            <polygon class="cls-2 svgh" points="38.33 30.8 36.87 30.8 37.8 31.12 38.33 30.8"/>
                                            <path class="cls-2 svgh" d="M8.2,32.57a16.81,16.81,0,0,0,3.11-1.48l.52-.29H4.46C4.89,31.51,6.18,33.22,8.2,32.57Z"/>
                                            <path class="cls-2 svgh" d="M3.11,31.09l.59-.29H1.31V34H7.17A5.1,5.1,0,0,1,3.11,31.09Z"/>
                                            <path class="cls-2 svgh" d="M47.48,30.8H42.82l1.91,1L44.12,33,40.5,31.05l-2.56,1.5-3.24-1.09H30.34a2.29,2.29,0,0,0-1.5.43A8.56,8.56,0,0,1,25.91,33c-1.8.42-2.29.48-2.62.05L23.2,33A1.8,1.8,0,0,1,22.3,32a3.91,3.91,0,0,0-.53-.8,4.61,4.61,0,0,1-.41.33,3.54,3.54,0,0,1-2.29.92,2.33,2.33,0,0,1-1.79-.74A2.64,2.64,0,0,0,15.7,31c-1.15-.23-2.35.45-3.74,1.24A18.17,18.17,0,0,1,8.6,33.82,4,4,0,0,1,7.49,34h40Z"/>
                                            <path class="cls-2 svgh" d="M7.31,34h0Z"/>
                                            <path class="cls-2 svgh" d="M4.29,30.52l-.59.29h.75C4.36,30.65,4.31,30.54,4.29,30.52Z"/>
                                            <path class="cls-1 svghv" d="M3.11,25.33c3.59-7.94,10.7-14.08,20-14.08.53,0,3.58,0,4.1.06,8.79.6,14.91,6.16,18.19,13.91Z"/>
                                            </svg>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="rst-dishes-action">
                                        ...
                                        <div class="rst-img-product">
                                            ...
                                            <defs>
                                            <style>
                                                .cls-1{fill:none;stroke:#5ccd69;stroke-miterlimit:10;stroke-width:2px;}
                                            </style>
                                            </defs>
                                            <title>aa</title>
                                            <path class="cls-1 svghv" d="M38.08,27.69l-.12,0a5.91,5.91,0,0,0-4.12-1,9.83,9.83,0,0,0,.43-2.87V19.65a2,2,0,0,0,.3.16,2.13,2.13,0,0,0,3.94-1.28L38.2,15c-.1-1.17-.8-8.54-2-8.44s-.78,7.64-.68,8.81h0L33.84,14.2c-1.22-3.68-5-5.58-9.45-5.58s-8.32,1.95-9.49,5.71l-1.5,1h0c.1-1.17.5-8.71-.68-8.81s-1.87,7.27-2,8.44l-.31,3.54a2.12,2.12,0,0,0,3.94,1.28l.14-.08v4.08a9.84,9.84,0,0,0,.63,3.44,5.45,5.45,0,0,0-4.07.1l-.21,0C9,28,8.62,32.3,10.13,37s4.29,7.95,6.2,7.33,2.24-4.76.82-9.34l.11,0c1.48,3.53,4.12,5.88,7.13,5.88s5.45-2.16,7-5.45c-1.46,4.36-1.24,8.31.56,9s4.81-2.46,6.51-7.06S40,28.39,38.08,27.69Z"/>
                                            </svg>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <a href="/contenido/productos.htm" class="btn btn-lg btn-success">Ver men&uacute;</a> </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="rst-visitors">
            <div class="text-center">
                <h3 style="margin-bottom: 0; padding: 70px 0 0; color: #fff; margin-top: 0; text-align: center;">PLATOS</h3>
            </div>
            <div class="container">
                ...
                <div class="col-sm-4">
                    ...
                    <ul class="rst-latest-news">
                        ...
                        <li>
                            ...
                            <p class="right-side-logo"> 3142002610 </p>
                            <div class="background-social background-facebook"></div>
                            <p class="right-side-logo"> <a href="https://www.facebook.com/colombian.broaster.77" target="blank">P&aacute;gina Oficial- Encuentranos en Facebook</a> </p>
                        </li>
                    </ul>
                </div>
                <div class="col-sm-4">
        ...
        <div class="rst-contact">
            ...
            <div  class="rst-contact-maps">
                <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCuORR5DPzE4CG5YdiEJsV8wn4TrKSbtWw&q=place_id:ChIJI6v2u9abP44RzMEdYXCSaWM&center=4.6310628,-74.083934" width="100%" height="100%" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
        </div>
        <!--- end Contact Detail/Map -->
    </div>
    <!--- end container -->
    ...
    <a href="https://api.whatsapp.com/send?phone=3142002610&amp;text=Hola,%20deseo%20hacer%20un%20pedido%20a%20domicilio." title="Pide Domicilio" target="_blank"  class="whatsapp">
