...
import com.mycompany.entidades.OrdenPK;
...
public class OrdenJpaController implements Serializable {
    ...
    public void create(Orden orden) throws PreexistingEntityException, Exception {
        if (orden.getOrdenPK() == null) {
            orden.setOrdenPK(new OrdenPK());
        }
        ...
        try {
            ...
            if (findOrden(orden.getOrdenPK()) != null) {
    ...
    public void destroy(OrdenPK id) throws NonexistentEntityException {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public Orden findOrden(OrdenPK id) {
        EntityManager em = getEntityManager();
        try {
