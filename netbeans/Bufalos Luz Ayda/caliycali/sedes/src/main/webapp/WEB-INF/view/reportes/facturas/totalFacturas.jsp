...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/factura/reportes/totalFacturasPDF.htm">
        <form target="_blank" method ="POST" action="<%=request.getContextPath()%>/factura/reportes/totalFacturasPDF.htm">
            <label>Fecha Inicial
