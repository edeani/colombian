...
<div id="formFactura" data-url="${pageContext.servletContext.contextPath}/factura/ajax/sede/formFactura.htm">
    <form:form target="_blank" commandName="${commandName}" path="DetalleFacturaDTO" action="${pageContext.servletContext.contextPath}/factura/guardarCambioSede.htm" >
        <div id="contenidoHome"> 
            ...
            <div id="campoNumeroFactura">
                ...
                <label>Sede
                    <form:select path="sede" data-url="${pageContext.servletContext.contextPath}/sedes/ajax/seleccionarSede.htm" disabled="true">
