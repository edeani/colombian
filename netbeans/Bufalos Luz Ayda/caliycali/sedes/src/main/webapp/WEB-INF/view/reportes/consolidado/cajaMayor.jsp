...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/consolidado/comprobante/reporte/movimiento/cajamayor/pdf.htm">
        <form target="_blank" action="<%=request.getContextPath()%>/consolidado/comprobante/reporte/movimiento/cajamayor/pdf.htm">
            <label>Fecha Inicial
