...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/consolidado/consolidadoPDF.htm">
        <form target="_blank" method ="POST" action="<%=request.getContextPath()%>/consolidado/consolidadoPDF.htm">
            <label>Fecha Inicial
