...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/factura/reportes/ventasTotalesPDF.htm">
        <form target="_blank" method ="POST" action="<%=request.getContextPath()%>/factura/reportes/ventasTotalesPDF.htm">
            <label>Fecha Inicial
