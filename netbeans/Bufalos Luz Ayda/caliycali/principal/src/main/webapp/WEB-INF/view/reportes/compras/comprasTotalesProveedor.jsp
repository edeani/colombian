...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/compras/reportes/comprasTotalesProveedorPDF.htm">
        <form   target="_blank" action="<%=request.getContextPath()%>/compras/reportes/comprasTotalesProveedorPDF.htm">
            <label>Fecha Inicial
