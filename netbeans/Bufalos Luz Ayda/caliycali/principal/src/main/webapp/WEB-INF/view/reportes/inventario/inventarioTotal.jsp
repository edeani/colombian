...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/inventario/reportes/inventarioTotalPDF.htm">
        <form target="_blank" action="<%=request.getContextPath()%>/inventario/reportes/inventarioTotalPDF.htm">
            <label>Fecha Inicial
