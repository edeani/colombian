...
<div id="contenidoHome">
    ...
    <div id="formFechas" data-url="<%=request.getContextPath()%>/compras/reportes/comprasTotalesProductoPDF.htm">
        <form target="_blank" action="<%=request.getContextPath()%>/compras/reportes/comprasTotalesProductoPDF.htm">
            <label>Fecha Inicial
