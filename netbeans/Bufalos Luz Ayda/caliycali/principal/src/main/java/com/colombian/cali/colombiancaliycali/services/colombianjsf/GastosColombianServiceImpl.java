...
public class GastosColombianServiceImpl implements GastosColombianService {
    ...
    public void gastos(Date fi, Date ff) {
        ...
        List<GastosReporteTotalColombialDto> gastosTotales = new ArrayList<GastosReporteTotalColombialDto>();
        try {
            ...
            gastosTotales = this.jdbctemplate.query(query, new BeanPropertyRowMapper<GastosReporteTotalColombialDto>(GastosReporteTotalColombialDto.class));
